...
if (isset($_POST['update']))
{
    ...
    $abc=$_POST['txtabc'];
    updateforId($id,$name,$class,$question,$abc);
}
?>
<head>
    <title>edit</title>
            ...
            <table>
                ...
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping" style="background-color:#CCFFFF">Người đăng:</span>
                    </div>
                    <input type="text" class="form-control" name="txtname" value="" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping">
                </div>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping" style="background-color:#CCFFFF">Lớp:</span>
                    </div>
                    <input type="text" class="form-control" name="txtclass" value="" placeholder="class" aria-label="Username" aria-describedby="addon-wrapping">
                </div>
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping" style="background-color:#CCFFFF">Câu hỏi:</span>
                    </div>
                ...
                <div class="input-group flex-nowrap">
                    <div class="input-group-prepend">
                        <span class="input-group-text" id="addon-wrapping" style="background-color:#CCFFFF">Nội dung:</span>
                    </div>
                ...
                <tr>
                    <td><input type="submit" name="create" value="Lưu" type="button" class="btn btn-primary" ></td>
                    <td style="background-color: #00bfbf"><input type="reset" name="reset" value="Reset" type="button" class="btn btn-primary"></td>
                </tr>
                </div>
            </table>
        </form>
