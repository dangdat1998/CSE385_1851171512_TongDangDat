...
<body>
<div style="text-align: right; margin: 0px 20px 0px 20px"><a href="thongtin.php"><?php
        session_start();
...
<div class="container">
    ...
    <div class="header">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="color:yellow; background-color: antiquewhite "><a href="create.php">Đặt câu hỏi</a></button>
    </div>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><a href="delete.php?id=<?php echo $user['0']?>"onclick="alert('Xóa thành công')"><i class="fas fa-trash-alt"></i></a></td>
