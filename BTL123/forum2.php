...
<div class="container">
    ...
    <div class="header">
        ...
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" style="color:yellow; background-color: antiquewhite "><a href="create2.php">Đặt câu hỏi</a></button>
    </div>
    <table class="table table-striped">
        ...
        <tr>
            ...
            <td><a href="delete2.php?id=<?php echo $user['0']?>"onclick="alert('Xóa thành công')"><i class="fas fa-trash-alt"></i></a></td>
